        ...
        <div className={`h-screen w-screen transition- bg-amber-100 ease-in-out duration-[1000ms] ${open ? "translate-x-0": "-translate-x-[100vw]"}` }>
            ...
            <div className={`shadow-xl h-screen w-half transition-all ease-in-out  duration-[1000ms] bg-amber-500/50 ${open ? "translate-x-[50vw] opacity-100": "translate-x-[200vw]  opacity-0"}`}>
                <div className='flex flex-col pt-[20vh]'>
                    <div className='pt-5 pl-4 cursor-pointer '><span className='text-5xl uppercase font-bold font-mono'>hello</span></div>
                    <div className='pt-5 pl-4 cursor-pointer '><span className='text-5xl uppercase font-bold font-mono'>hola</span></div>
                    <div className='pt-5 pl-4 cursor-pointer '><span className='text-5xl uppercase font-bold font-mono'>amigos</span></div>
                    <div className='pt-5 pl-4 cursor-pointer '><span className='text-5xl uppercase font-bold font-mono'>valorant</span></div>
                    <div className='pt-5 pl-4 cursor-pointer '><span className='text-5xl uppercase font-bold font-mono'>fck off</span></div>
                </div>
        </div>
        </div>
